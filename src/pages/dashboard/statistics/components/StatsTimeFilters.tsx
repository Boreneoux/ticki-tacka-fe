...
export default function StatsTimeFilters({
  filterBy,
  year,
  month,
  onFilterByChange,
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      {/* Year selector (always visible for month and day; always visible for year too) */}
      {(filterBy === 'month' || filterBy === 'day' || filterBy === 'year') && (
        <select
          value={year}
